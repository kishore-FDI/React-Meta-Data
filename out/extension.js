        ...
        try {
            ...
            await vscode.window.withProgress({
                ...
                if (fs.existsSync(indexHtmlPath)) {
                    ...
                    htmlContent = htmlContent.replace(/<!-- Auto-generated meta tags -->[\s\S]*?<!-- End auto-generated meta tags -->/, '');
...
async function findReactComponents(rootPath) {
    const components = [];
...
function isReactComponent(fileName) {
    ...
    try {
        ...
        return (content.includes('<') && content.includes('/>') || // JSX self-closing tags
...
function generateMetaTagsFile(metadata) {
...
async function extractMetaData(sourceCode, filePath = '') {
    const metadata = {
        filePath: filePath,
        title: '',
        description: '',
    ...
    try {
        ...
        const contentVariables = new Map();
                            ...
                            if (element.type === 'ObjectExpression') {
                                element.properties.forEach((prop) => {
                                    ...
                                    // Extract array of features
                                        ...
                                        prop.value.elements.forEach((feature) => {
                    ...
                    try {
                        ...
                        if (path.node.value.type === 'StringLiteral') {
                            ...
                            // Handle array/object member expressions
                                ...
                                const objName = path.node.value.expression.object.name;
